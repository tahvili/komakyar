	...
	<header class="site-header navbar navbar-expand-lg align-items-center w-100 z-index-10 navbar-light">
		<div class="position-relative container-fluid">
			<div class="ml-auto maxed-out">
				<div class="menu-mix">
					<a href="/" class="navbar-brand logo mt-3 mt-lg-0 ml-lg-4 d-block d-lg-inline-block"><img
							src="../assets/img/logo.svg" class="" alt="Komakyar Logo"></a>
					<?php menu(); ?>
				</div>
			</div>
			<div class="mr-auto">
				<?php main_sponsor(); ?>
				<a class="clientarea" href="../app/login.php"><img src="../assets/img/user.svg" class="client-area"
						alt="Client Area"></a>
			</div>
		</div>
